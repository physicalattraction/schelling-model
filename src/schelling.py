...
class Schelling:
    def __init__(self, width: int, height: int, empty_ratio: float, similarity_threshold: float,
        ...
        # If there are less than this percentage of similar people, you are unhappy
        self.similarity_threshold = similarity_threshold
        self.n_iterations = nr_iterations
        self.empty_houses = []
        self.agents = {}
